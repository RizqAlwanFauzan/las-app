...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Berikut adalah pesan kesalahan default yang digunakan oleh
    | kelas validator. Beberapa aturan memiliki beberapa versi
    | seperti aturan ukuran. Silakan ubah masing-masing pesan ini di sini.
    |
    */
    ...
    | menggunakan konvensi "atribut.rule" untuk memberi nama baris. Ini
    | memudahkan untuk menentukan baris bahasa kustom yang spesifik untuk
    ...
    */
    ...
    | sebagai pengganti "email". Ini membantu kita membuat pesan kita
    | lebih ekspresif.
    |
    */
